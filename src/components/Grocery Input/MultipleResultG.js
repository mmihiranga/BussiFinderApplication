...
const MultipleResultG = () => {
    ...
    const downloadReport = (i) => {
        ...
        const doc = new jsPDF();
                    ...
                    doc.text(`Traffic Summation : ${businessDetails.value[j].locationFeatures.trafficSum}`, 20, 60);
                    doc.text(`In-Store-Shopping : ${businessDetails.value[j].locationFeatures.Instoreshopping}`, 20, 70);
                    doc.text(`Delivery : ${businessDetails.value[j].locationFeatures.Delivery}`, 20, 80);
                    doc.text(`Website : ${businessDetails.value[j].locationFeatures.Website}`, 20, 90);
                    doc.text(`Competitors Count : ${businessDetails.value[j].locationFeatures.competitorsCount}`, 20, 100); 
                    doc.setFont("helvetica", "bold");
                    doc.text(`Final Prediction : ${businessDetails.value[j].ml_result}%`, 20, 110);
                    doc.save("Report.pdf"); 
                ...
                >
                    ...
                    <Box
                        ...
                        <Box className={classes.featuresBoxFlex}>
                            ...
                            <Box className={classes.featuresBox}>
                                <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 500 } : {})} >
                                    <div className={classes.features}><GiPathDistance style={{ color: '#df5e52',fontSize: '20px' }} />Competitors Count  - {businessDetails.value[i].locationFeatures.competitorsCount}</div>
                                </Grow>
                                <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 800 } : {})} >
                                    <div className={classes.features}><HiShoppingBag style={{ color: '#2f9f48',fontSize: '20px' }} />Traffic around the area - {businessDetails.value[i].locationFeatures.trafficSum}</div>
                                </Grow>
                    ...
                    <Box className={classes.featuresBoxFlex}>
                        ...
                        <Box className={classes.featuresBox}>
                        <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 1100 } : {})} >
                                    <div className={classes.features}><AiOutlineShoppingCart style={{ color: '#ce7c39',fontSize: '20px' }} />In-store shopping - {businessDetails.value[i].locationFeatures.Instoreshopping}</div>
                            </Grow>
                            <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 1400 } : {})} >
                                    <div className={classes.features}><TbTruckDelivery style={{ color: '#df5e52',fontSize: '20px' }} />Delivery  - {businessDetails.value[i].locationFeatures.Delivery}</div>
                            </Grow>
                            <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 1400 } : {})} >
                                    <div className={classes.features}><BiWorld style={{ color: '#e2da5f',fontSize: '20px' }} /> Website - {businessDetails.value[i].locationFeatures.Website}</div>
                            </Grow>
                            <Grow in={checked} style={{ transformOrigin: '0 0 0' }} {...(checked ? { timeout: 1400 } : {})} >
                                    <div className={classes.features}><RiParkingBoxLine style={{ color: '#e2da5f',fontSize: '20px' }} /> Parking - {businessDetails.value[i].locationFeatures.Parking}</div>
                            </Grow>
...
export default MultipleResultG